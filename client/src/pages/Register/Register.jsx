              ...
              >
                ...
                <button
                  ...
                  className={
                    ...
                    !checkPhone ||
                    !checkUsername
                      ? "mt-3 mx-auto w-full bg-gray-300 rounded-md text-white py-2 border-2"
                      : "mt-3 mx-auto w-full bg-blue-700  text-white py-2 border-2 border-black rounded-md homeshadow"
                  }
                >
                  Sign Up
                </button>
