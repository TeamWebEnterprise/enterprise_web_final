...
export const SuccessVerifyMail = () => {
  ...
  useEffect(() => {
    try {
      fetch(`http://localhost:3001/emailverify?token=${token}`);
    } catch (err) {
      console.log("error");
    }
  }, []);
  ...
  return (
    <section className=" flex justify-center items-center bg-slate-200 min-h-screen pl-5 pr-5">
      <div className=" bg-white shadow-xl max-w-xl p-14 item-center mx-auto rounded-3xl ml-5 mr-5">
        <svg
        ...
        <div>
          <h1 className="text-2xl text-center font-mono  mb-5">
            Verify your email address Success!
          </h1>
          <a
            href="/"
            className="bg-blue-600 text-white px-5 py-2 rounded-lg homeshadow flex items-center justify-center mx-auto "
          >
            Home
          </a>
        </div>
